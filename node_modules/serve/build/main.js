#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/Users/jeremyhuot/.vscode/extensions/wallabyjs.console-ninja-1.0.381/out/buildHook/index.js').default({tool: 'serve', checkSum: '20d0d3f2ae027448b1e75fVQRKAUgCWwAEClZWDA1WV1RSVFJc', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/jeremyhuot/.vscode/extensions/wallabyjs.console-ninja-1.0.381/out/buildHook/index.js').then(m => m.default.default({tool: 'serve', checkSum: '20d0d3f2ae027448b1e75fVQRKAUgCWwAEClZWDA1WV1RSVFJc', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
